...
open class TestDetails @JsonCreator constructor(
	 ...
	 */
	@JvmField @param:JsonProperty("content") var content: String?
) {
	override fun equals(other: Any?): Boolean {
		...
		return uniformPath == that.uniformPath && sourcePath == that.sourcePath && content == that.content
	}
