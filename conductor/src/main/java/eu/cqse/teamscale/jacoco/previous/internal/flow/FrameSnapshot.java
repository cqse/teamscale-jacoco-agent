 ...
 */
class FrameSnapshot implements eu.cqse.teamscale.jacoco.previous.internal.flow.IFrame {
	 ...
	 */
	static eu.cqse.teamscale.jacoco.previous.internal.flow.IFrame create(final AnalyzerAdapter analyzer, final int popCount) {
