...
public abstract class MethodProbesVisitor extends MethodVisitor {
	...
	public void visitJumpInsnWithProbe(final int opcode, final Label label,
			final int probeId, final eu.cqse.teamscale.jacoco.previous.internal.flow.IFrame frame) {
	}
	 ...
	 * {@link eu.cqse.teamscale.jacoco.previous.internal.flow.LabelInfo#getProbeId(Label)}.
	 * 
	 * @param min
	...
	public void visitTableSwitchInsnWithProbes(final int min, final int max,
			final Label dflt, final Label[] labels, final eu.cqse.teamscale.jacoco.previous.internal.flow.IFrame frame) {
	}
