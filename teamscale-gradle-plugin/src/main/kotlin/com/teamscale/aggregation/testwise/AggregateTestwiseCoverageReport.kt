...
/**
 * [ReportSpec] that holds a [TestwiseCoverageReport] task for aggregating the binary data produced
...
interface AggregateTestwiseCoverageReport : ReportSpec {
	/**
	 * Contains the [TestwiseCoverageReport] task instance which produces this report.
	 *
