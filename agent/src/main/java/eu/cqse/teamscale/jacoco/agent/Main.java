...
public class Main {
	...
	static {
		ResourceBundle bundle = ResourceBundle.getBundle("eu.cqse.teamscale.jacoco.agent.app");
	...
	private void parseCommandLineAndRun(String[] args) throws Exception {
		...
		if (defaultArguments.help) {
			System.out.println("Teamscale JaCoCo agent " + VERSION + " compiled against JaCoCo " + JaCoCo.VERSION);
			jCommander.usage();
			return;
		}
