...
copy-item $securityPolicyFile $securityPolicyFileBackup
$securityPolicyFile | out-file "$PSScriptRoot/javaPath.bak"
copy-item "$PSScriptRoot/agent.policy" $securityPolicyFile
